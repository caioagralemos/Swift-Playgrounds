        ...
        ScrollView {
            ...
            VStack(alignment: .leading) {
                ...
                HStack(spacing: 2, content: {
                    ...
                    Text("Desde pequeno sempre fui apaixonado por tecnologia!").font(.title).padding()
            ...
            .frame(maxWidth: .infinity) // extende a VStack horizontalmente
            .background(.black, in: RoundedRectangle(cornerRadius: 15)) // dá o fundo preto e arredonda as bordas
            .padding() // adiciona padding entre a vstack e as bordas da view
